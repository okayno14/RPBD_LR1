...
SQLWCHAR* Person::getLastName(){return this->lastName;}

SQLWCHAR* Person::getFirstName(){return this->firstName;}

SQLWCHAR* Person::getFatherName(){return this->fatherName;};
